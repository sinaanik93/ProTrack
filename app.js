...
function renderReport() {
  ...
  const reportSections=[
    reportSection(1,"Dashboard Database Output",`<pre class="json-output">${esc(JSON.stringify(schema,null,2))}</pre>`),
